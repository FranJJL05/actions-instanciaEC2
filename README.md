...
2.  **CD (Despliegue Continuo):** Utiliza los Secrets de SSH (`EC2_KEY`, `EC2_HOST`) para conectarse a la instancia EC2 y copiar los archivos (`src/` y `docs/`) a la ruta del servidor (`/var/www/html/app`).
